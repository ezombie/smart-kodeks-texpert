...
- [Автоматизация исполнение скрипта](chapter-71.md#автоматизация-исполнения-скрипта)
...
Обязательно выставить исполнение вне зависимости от пользовтаеля и с наивысшими правами - при некоторых настройках групповых и локальных политик безопасности, программе может оказаться невозможно писать файлы в свою же папку.
А это недопустимо.
...
Таким образом, задача не будет выполнена.
...
После всех настроек задачи система спросит у вас пароль, если был выставлен крыжик "Выполнять с наивысшими правами".

Если учетка, под которой заводилась задача, обладает локальными правами администратора, то ввести ее пароль.
Иначе - ввести омя и пароль такой учетки, чьи права позволяют завершить выставление задачи в планировщик.
...
Кроме того - если по этой установке стали строиться график в Grafana - значит вск верно настроено, с автоматизацией.
