...
- [ОБЩИЕ РЕКОМЕНДАЦИИ ПО ПОДГОТОАКЕ К ВНЕДРЕНИЮ](077-smart-implementation-experience.md)
- [РЕКОМЕНДАЦИИ ПО ВНЕДРЕНИЮ ДЛЯ МЕНЕДЖЕРОВ ПО СОПРОВОЖДЕНИЮ/СБЫТУ](077-smart-implementation-experience.md#подготовка-к-внедрению-рекомендации-для-менеджера-отдела-сопровождениясбыта)
- [РЕКОМЕНДАЦИИ ПО ВНЕДРЕНИЮ ДЛЯ ТЕХНИЧЕСКИХ СПЕЦИАЛИСТОВ](077-smart-implementation-experience.md#подготовка-к-внедрению-рекомендации-для-технических-специалистов)
