...
Общий принцип внедрения скрипта smartstatus весьма похожа на [принцип внедрения smartupload](051-smartupload-implementation-windows).
...
Если тебе нужно внедрить smartstatus в ОС Windows, то [читай дальше.](053-smartstatus-implementation-windows#подготовка-скрипта-smartstatus)

Если тебе нужно внедрить smartstatus в ОС Linux, то [тебе сюда.](055-smartstatus-implemetation-linux)
...
Можно и нужно использовать ту же последовательность действий, которая [описана для smartupload.](051-smartupload-implementation-windows#разворачиваyие-утилиты-curl-внедрение-скрипта) 
