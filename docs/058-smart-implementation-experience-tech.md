...
[вот отсюда.)](057-smart-implementation-experience-manager)
...
[Рекомендации о том, как заполнять файл online_example.csv размещены вот тут.](054-smartonline-implementation)
