...
![Биллинг онлайн](img/billing-online/billing-online-chart.png "Биллинг онлайн")
...
![Осталось Документы](img/billing-online/billing-docs-left.png "Осталось Документы")
...
![Осталось Поиск](img/billing-online/billing-search-left.png "Осталось Поиск")
...
![Осталось Печать и Осталось Выгрузка](img/billing-online/billing-print-download-left.png "Осталось Печать и Осталось Выгрузка")
...
![Средний процент использования лимита документов по всем клиентам](img/billing-online/average-docs-left-all-clients.png "Средний процент использования лимита документов по всем клиентам")
...
![Средний процент использования лимита документов по всем клиентам менеджера](img/billing-online/average-docs-left-manager.png "Средний процент использования лимита документов по всем клиентам менеджера")
...
![Ошибки подключения к серверам](img/billing-online/billing-online-errors.png "Ошибки подключения к серверам")
