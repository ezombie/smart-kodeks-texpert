...
График служит для отображения времени когда ПК находился в состяниях:
- Режим обслуживания
...
Для работы данного функционала на сервер с ПК необходимо устанавливать и настраивать дополнительное ПО [telegraf](https://www.influxdata.com/time-series-platform/telegraf/).
Обсуждение по настройки данного функционала осуществляется индивидуально.

### Статусы on-line проверок

<img src="img/kodeks-server-metrics/emergency-02.png" alt="Статусы on-line проверок" align=top>
...
При определённых состояних ПК НЕСКОЛЬКО проверок могут принять значение "0" и это не приведёт к позникновению аварийной ситуации.
