...
Общий принцип внедрения практически ничем не отличается от описанного [здесь.](051-smartupload-implementation-windows#подготовка-скрипта-smartupload)
...
[Ничем не отличается от описанного здесь.](051-smartupload-implementation-windows#подготовка-скрипта-smartupload)
