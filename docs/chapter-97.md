...
Дополнительно у клиента стало появляться больше пользователей в Техэксперт, приведенных самим менеджером + акционными вебинарами + с сайта docs.cnrd.ru.
...
Это же было видно и дашборде [Биллинг Онлайн](chapter-83.md).
...
В результате аналитики были проведены переговоры к пользователями о допоставке.
