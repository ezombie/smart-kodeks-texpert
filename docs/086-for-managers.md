...
{ЗДЕСЬ НУЖЕН КОРРЕКНЫЙ СКРИНШОТ}

Данная таблица отображает данные о том, когда и на какой или каких установках крайний раз были обновлены OperUp.
...
<img src="img/for managers/users involvment.png" alt="Вовлеченность пользователей" align=top>
