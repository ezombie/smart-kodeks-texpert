...
Однако, менеджерам отдела сбыта, также будет полезен данный дашборд - в том случае, когда под контроль СМАРТа ставятся апробационные установки, и менеджер по сбыту 
нуждается в дополнительной информаци о том, насколько на практике будут востребованы продаваемые установки и нуждаются ли они в коррекции по составу продуктов
и/или по количеству рабочих мест до того, как клиент заплатит за это все счастье.
...
- в средней перспективе при успешной работе отвественного менеджера, усилиями последнего будет создана ситуация, когда рабочих мест станет не хватать на всех, что,
...
Для аналогичного контроля по простым онлайнам следует использвоать дашборд [Биллинг Онлайн.](083-billing-online.md)
...
Кроме того, график, как и многие прочие в СМАРТе, позволяет выполнять сортировку по данным, указанным справа от самого гарфика:
...
Данные с этого графика можно использовать для анализа того, насколько активны пользователи, в каком количестве активны пользователи на той или иной установке.
Такая аналитическая информация может быть использована для поиска ответов на вопрос о востребованности установки у того или иной клиента.
