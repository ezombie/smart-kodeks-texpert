...
Кроме того, график может быть полезен для ситуации, когда очень точечно нужно отслеживать нагрузку, востребованность внедренного ПК; 
...
[Листай дальше](087-for-managers.md)
