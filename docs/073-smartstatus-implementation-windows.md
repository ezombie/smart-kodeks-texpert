...
Общий принцип внедрения скрипта smartstatus весьма похожа на [принцип внедрения smartupload](071-smartupload-implementation-windows.md).
...
Если тебе нужно внедрить smartstatus в ОС Windows, то [читай дальше.](073-smartstatus-implementation-windows.md#подготовка-скрипта-smartstatus)

Если тебе нужно внедрить smartstatus в ОС Linux, то [тебе сюда.](075-smartstatus-implemetation-linux.md)
...
Можно и нужно использовать ту же последовательность действий, которая [описана для smartupload.](071-smartupload-implementation-windows.md#разворачиваyие-утилиты-curl-внедрение-скрипта) 
