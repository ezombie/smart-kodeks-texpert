...
Общий принцип внедрения скрипта smartstatus весьма похожа на [принцип внедрения smartupload](chapter-71.md).
...
Если тебе нужно внедрить smartstatus в ОС Windows, то [читай дальше.](chapter-73.md#подготовка-скрипта-smartstatus)

Если тебе нужно внедрить smartstatus в ОС Linux, то [тебе сюда.](chapter-75.md)
...
Можно и нужно использовать ту же последовательность действий, которая [описана для smartupload.](chapter-71.md#разворачиваyие-утилиты-curl-внедрение-скрипта) 
