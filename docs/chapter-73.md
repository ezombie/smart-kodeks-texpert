...
Данный дашборд по степени значимости с точки зрения получения аналитической и статистической информации ничем не уступает дашборду [Kodeks аналитика](chapter-72.md#kodeks-аналитика).
...
- дня месяца;
- привычек и тенденций к исчерпанию показателя в прошлом (за дополнительной информацией смотри [вот этот график](chapter-73.md#осталось--документы-));
...
Здесь, конечно, не так насыщенно, как с дашбордом ["Kodeks аналитика"](chapter-72.md), но все равно - немало полезной информации.

Но ты и здесь справился! МОЛОДЕЦ!

Теперь ты можешь смело:
- нырять [дальше](chapter-74.md) в информационные глубины СМАРТа; 
- вернуться [назад](chapter-73.md#биллинг-онлайн);
