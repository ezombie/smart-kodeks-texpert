...
График отображает количество учеток пользователей на каждой подконтрольной установке, кто не заходил в ПК в течение 60 дней от даты крайнего своего появления.
