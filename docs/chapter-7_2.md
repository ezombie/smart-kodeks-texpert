...
- и прочие разные, более специцфичные причины.
...
График отображает количественное суммарное значение всех запросов к БД, сделанных по всем подконтрольным установкам (всеми учестками на этих установках) за заданный период времени.
