...
- нужно получать уведомления о случах сбоя в работе ПО или обновлениях максимально оперативно;
- руководитель не хочет зависеть от «человеческого фактора» (звонок клиента «у нас ничего не работает»), в том числе и со 
стороны своих подчинённых (болезнь, невнимательность и т.д.);
...
- для быстрого составления регулярного отчета ЛПРу, составляемого менеджером по сопровождению отдела/департамента сопровождения
в рамках пролонгации;
- для "правильного" использования нового функционала подсистемы "SYSMON", внедренной разработчиком ИСС Кодекс/Техэксперт
в феврале 2026 года.
...
- Для интранет ПК настроить выполнение по расписанию скрипт smartupload и скрипта smartstatus;
...
- Проверка на наличие ошибок с БД (целостность, нарушение лицензии, соответствие номера обновления БД и лицензии);
- Проверка актуальности файлов operup (не старше 2 суток);
...
- Алертинг на исчерпание свободных рабочих мест на установке в течение 5 минут от момента наступления такого события;
- Аналитика;
- и другие.
...
- Почасовая статистика по утилизации рабочих мест у клиента;
